...
Text editor built for GNOME on top of [PyGObject](https://pygobject.readthedocs.io/en/latest/), Python 3 and GTK4. Project under development so it will be massively changing in time :)
